# 面向 RustOS 的进程调试能力构建 — 科研实践答辩（19 页、图文版）
...
> **节奏建议（5 min ≈ 每页 15 s）**：背景/目标 1 页带过，重点讲第 5、8、9、13、14 页（架构、状态机、统一停止、断点闭环、安全），其余快速扫过。
...
## 第 7 页 — 2.3 tracer / tracee 关系与固定锁序
...
## 第 11 页 — 2.7 跨进程内存访问：VMAR alien access
...
## 第 12 页 — 2.8 x86-64 寄存器 ABI：字段级写策略
...
| 5 | `01_arch_overview.png` | 七层总体架构 |
| 6 | `02_ptrace_dispatch.png` | ptrace 请求分发 |
| 7 | `03_tracer_tracee.png` | 关系与锁序（Arc/Weak） |
| 8 | `04_state_machine.png` | ptrace-stop 主状态机 |
| 9 | `05_three_stops.png` | 三类停止统一收敛 |
| 10 | `06_signal_states.png` | 信号四态机 |
| 11 | `07_mem_access.png` | VMAR alien access |
| 12 | `08_register_abi.png` | 寄存器字段级策略 |
| 13 | `09_breakpoint_loop.png` | 断点闭环 |
| 14 | `10_security_model.png` | 安全模型 + Yama |
| 15 | `11_timeline.png` | 进度时间线 |
