...
pub(in crate::arch) const USER_CS: SegmentSelector = SegmentSelector::new(6, PrivilegeLevel::Ring3);
pub(in crate::arch) const USER_SS: SegmentSelector = SegmentSelector::new(5, PrivilegeLevel::Ring3);
