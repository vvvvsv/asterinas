...
use super::{ROOT_VMAR_CAP_ADDR, ROOT_VMAR_GROWUP_BASE};
use crate::prelude::*;

pub(super) trait VmAllocator {
...
#[expect(unused)]
pub(super) struct SimpleAllocator {
...
pub(super) struct PerCpuAllocator(Vec<PerCpuLast>);
